...
/// In order to be passed to C, this function needs to be global
internal func GroupMemberHandler(conversationIdRef: UnsafePointer<Int8>?, callMembersRef: UnsafeMutablePointer<wcall_members>?, contextRef: UnsafeMutableRawPointer?)
{
